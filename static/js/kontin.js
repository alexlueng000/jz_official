(function ($) {
  ...
  if ($(".video-popup").length) {
    $(".video-popup").on("click", function(e) {
      ...
      var videoHtml = '<div class="video-popup-content" style="padding:20px;background:#000;"><video controls autoplay style="max-width:100%;max-height:80vh;display:block;margin:0 auto;"><source src="' + videoSrc + '" type="video/mp4">Your browser does not support the video tag.</video></div>';
      ...
      $.magnificPopup.open({
        ...
        callbacks: {
          close: function() {
            ...
            $(".video-popup-content video").each(function() {
              this.pause();
            });
          }
        }
